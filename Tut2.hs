...
the3rdOf2nd :: [(a, b, c)] -> c
the3rdOf2nd = the3rd . the2ndInList

-- Q3. Algebraic Data Type
-- Let us define a fairly complex data type with a number of possible values

data Days = Monday | Tuesday | Sunday

data IntOrString = IntT Int | StringT String
...
updateName :: String -> T -> T
updateName str (DDD {name = n, age = a}) = DDD {name=str, age=a}
updateName str _ = error "NO match in record selector name"
